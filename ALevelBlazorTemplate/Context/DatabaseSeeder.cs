    ...
    public class DatabaseSeeder
    {
        ...
        private List<Cheese> GetCheeses()
        {
            ...
            [
                ...
                new Cheese { Name = "Mozzarella Fresca", Type = "Fresh", Description = "An Italian classic, known for its soft and stretchy texture, ideal for melting on pizzas or layering in caprese salads.", Strength = "Mild", Price = 6.49m, ImageUrl="mozzarella.png" },
                new Cheese { Name = "Parmesan Prestige", Type = "Hard", Description = "A renowned Italian cheese with a granular texture and rich, nutty flavor, often grated over pasta dishes or salads.", Strength = "Strong", Price = 12.99m,ImageUrl="parmesan.png" },
                new Cheese { Name = "Swiss Bliss", Type = "Semi-Hard", Description = "A Swiss cheese with a slightly sweet and nutty taste, characterized by its iconic holes and smooth texture.", Strength = "Medium", Price = 9.49m, ImageUrl="swiss.png" },
                new Cheese { Name = "Feta Fancy", Type = "Soft", Description = "A crumbly and tangy Greek cheese made from sheep's milk, perfect for adding a savory kick to salads or pastries.", Strength = "Mild", Price = 7.99m, ImageUrl="feta.png" },
                new Cheese { Name = "Havarti Harmony", Type = "Semi-Soft", Description = "A Danish cheese with a creamy and buttery taste, featuring small irregular holes and a mild, nutty flavor profile.", Strength = "Medium", Price = 8.99m, ImageUrl="havarti.png" },
                new Cheese { Name = "Pepper Jack Passion", Type = "Semi-Soft", Description = "A spicy American cheese infused with jalapeño peppers, offering a zesty kick and creamy texture, perfect for sandwiches or melting on burgers.", Strength = "Medium", Price = 7.99m, ImageUrl="pepperjack.png" },
                new Cheese { Name = "Colby Comfort", Type = "Semi-Hard", Description = "An American cheese similar to cheddar but milder in flavor, featuring a firm texture and smooth finish, great for snacking or melting.", Strength = "Mild", Price = 6.99m, ImageUrl="colby.png" },
                new Cheese { Name = "Gorgonzola Glory", Type = "Blue", Description = "An Italian blue cheese with a crumbly texture and bold, tangy flavor, perfect for adding depth to salads or pairing with fruits and nuts.", Strength = "Strong", Price = 10.99m, ImageUrl="gorgonzola.png" },
                new Cheese { Name = "Provolone Perfection", Type = "Semi-Hard", Description = "An Italian cheese with a mild and slightly smoky flavor, often used for sandwiches, pasta dishes, or eaten on its own as a snack.", Strength = "Medium", Price = 8.49m, ImageUrl="provolone.png" },
