...
namespace MyCheeseShop.Migrations
{
    ...
    [Migration("20240418124906_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCheeseShop.Model.Cheese", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyCheeseShop.Model.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyCheeseShop.Model.OrderItem", b =>
                {
                    b.HasOne("MyCheeseShop.Model.Cheese", "Cheese")
                        .WithMany()
                        .HasForeignKey("CheeseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyCheeseShop.Model.Order", "Order")
                        .WithMany("Items")
